...
void gpu_predict_batch_cuda(char *__feat_vec, int n_vecs, long **weights) {
	//do inference
	void *args[] = {
		&weights[0], &weights[2], &d_input_vec_i_cuda, &d_mid_res_i_cuda
	};
	void *args1[] = {
		&weights[1], &weights[3], &d_mid_res_i_cuda, &d_final_res_i_cuda
	};

    check_error(cuLaunchKernel(batch_linnos_mid_layer_kernel_cuda, 
				n_vecs, 1, 1,          //blocks
				256, 1, 1,   //threads per block
				0,   //shared mem
                NULL, args, NULL),
    ...
    check_error(cuLaunchKernel(batch_linnos_final_layer_kernel_cuda, 
				n_vecs, 1, 1,          //blocks
				64, 1, 1,   //threads per block
				0,   //shared mem
                NULL, args1, NULL),
...
void gpu_predict_batch_plus_1_cuda(char *__feat_vec, int n_vecs, long **weights) {
	//do inference
	void *args[] = {
		&weights[0], &weights[2], &d_input_vec_i_cuda, &d_mid_res_i_cuda
	};
	void *args1[] = {
		&weights[1], &weights[3], &d_mid_res_1_i_cuda, &d_final_res_i_cuda
	};

	void *args2[] = {
		&weights[4], &weights[5], &d_mid_res_i_cuda, &d_mid_res_1_i_cuda
	};
    check_error(cuLaunchKernel(batch_linnos_mid_layer_kernel_cuda, 
				n_vecs, 1, 1,          //blocks
				256, 1, 1,   //threads per block
	...
	check_error(cuLaunchKernel(batch_linnos_mid_layer_1_kernel_cuda, 
				n_vecs, 1, 1,          //blocks
				256, 1, 1,   //threads per block
				0,   //shared mem
                NULL, args2, NULL),
...
void gpu_predict_batch_plus_2_cuda(char *__feat_vec, int n_vecs, long **weights) {
	//do inference
	void *args[] = {
		&weights[0], &weights[2], &d_input_vec_i_cuda, &d_mid_res_i_cuda
	};
	void *args1[] = {
		&weights[1], &weights[3], &d_mid_res_2_i_cuda, &d_final_res_i_cuda
	};
	...
	void *args3[] = {
		&weights[6], &weights[7], &d_mid_res_1_i_cuda, &d_mid_res_2_i_cuda
	};
	...
	check_error(cuLaunchKernel(batch_linnos_mid_layer_2_kernel_cuda, 
				n_vecs, 1, 1,          //blocks
				256, 1, 1,   //threads per block
				0,   //shared mem
                NULL, args3, NULL),
